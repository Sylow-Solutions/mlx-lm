...
"""
Example of pipeline parallel generation with Llama models.
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Llama pipelined inference example")
    parser.add_argument(
        "--model",
    ...
    parser.add_argument(
        "--prompt",
        "-p",
        default="Write a quicksort in Python.",
    ...
    for response in stream_generate(
        model, tokenizer, prompt, max_tokens=args.max_tokens, temperature=args.temp
    ):
